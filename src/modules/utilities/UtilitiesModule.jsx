...
function TunisiaNetworkMapCard({ className = '' }) {
  return (
    <div className={`flex h-full flex-col rounded-2xl border border-slate-200 bg-gradient-to-br from-sky-50 via-white to-slate-50 p-5 shadow-sm ${className}`}>
      ...
      <div className="mx-auto flex w-fit max-w-full overflow-hidden rounded-2xl border border-slate-200 bg-white p-0">
        <div className="mx-auto flex w-fit items-center justify-center overflow-hidden bg-white">
          <img
