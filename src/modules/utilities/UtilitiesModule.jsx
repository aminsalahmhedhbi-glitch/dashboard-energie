...
const INITIAL_PERIMETRE = {
  ...
  reseau: {
    propre: [
      { id: 301, text: 'Si�ge Megrine', lieu: 'Si�ge Megrine' },
      ...
      { id: 304, text: 'SAV El Khadhra', lieu: 'Si�ge Megrine / SAV El Khadhra' },
...
function TunisiaNetworkMapCard({ className = '' }) {
  return (
      <div className={`flex h-full flex-col rounded-2xl border border-slate-200 bg-gradient-to-br from-sky-50 via-white to-slate-50 p-5 shadow-sm ${className}`}>
        ...
        <div className="flex h-[520px] w-full items-center justify-center overflow-hidden rounded-xl border border-slate-200 bg-white leading-none lg:h-[620px]">
          <img
            src={reseauPropreMockup}
            alt="Reseau ITALCAR en Tunisie"
            className="block h-[112%] w-[112%] max-w-none object-contain object-center"
          />
        </div>
      </div>
  );
              ...
              <div className="space-y-8 text-slate-700">
                <div className="grid grid-cols-1 gap-8 xl:grid-cols-12">
                  ...
                  <div className="flex h-full flex-col gap-6 xl:col-span-8">
                    <div className="shrink-0 overflow-hidden rounded-2xl border border-transparent bg-gradient-to-br from-[#233876] to-[#3653a6] p-7 text-white shadow-lg">
